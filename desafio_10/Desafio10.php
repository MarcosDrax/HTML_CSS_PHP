    ...
    <body>
        <main>
            ...
            <form action="<?=$_SERVER['PHP_SELF']?>" method="POST">
                ...
                <input type="number" name="nasc" id="inasc" value="<?=$anoNasc?>">
                <label for="inum">Quer saber sua idade em que ano? (atualmente estamos em 2024)</label>
                <input type="number" name="atual" id="iatual" value="<?=$anoAtl?>">
        ...
        <section id="resultado">
            <h2>Cálculo das Médias</h2>
                <?php
                    if (($anoNasc == 0) and ($anoAtl == 0)) {
                        echo "Digite o Ano para calcular sua Idade";
                    }
                    $idadeAtl = number_format( $anoAtl - $anoNasc);
